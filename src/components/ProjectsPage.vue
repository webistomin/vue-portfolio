<template>
  <div>
    <header class="page-header page-header--blue" role="banner">
      <div class="page-header__inner page-header__inner--blue">
        <div class="page-header__links page-header__links--high">
          <button
        ...
        <div class="page-header__logotype page-header__logotype--padding">
          <h1 class="page-header__logo">
            <router-link tag="a" to="/" class="page-header__home">Istomin.</router-link>
          </h1>
          <span class="page-header__desc">{{ $t('pageHeader.desc') }}</span></div>
        ...
        <nav class="main-nav main-nav--closed main-nav--padding"
             :class="{'main-nav--opened' : isOpened}"
             role="navigation">
          <ul class="main-nav__list">
            <li class="main-nav__item main-nav__item--blue">
              <router-link tag="a" to="/" class="main-nav__link main-nav__link--white">
        ...
        <section class="socials socials--hidden">
          <ul class="socials__list socials__list--justify">
            <li class="socials__item socials__item--white socials__item--square">
              <a href="https://t.me/webistomin" class="socials__link" target="_blank"
                 rel="noopener noreferrer" title="Telegram">
                <svg class="socials__icon socials__icon--blue socials__icon--rotate" width="30" height="30">
            ...
            <li class="socials__item socials__item--white socials__item--square"><a
              href="https://www.linkedin.com/in/webistomin/" class="socials__link"
    ...
    <main class="page-content">
      <div class="container">
        <section class="portfolio" id="portfolio">
          <h3 class="portfolio__title title">All projects</h3>
          <ul class="portfolio__list">
              ...
              <figure class="portfolio__figure">
                <picture>
                  <source type="image/webp" media="(min-width: 1200px)"
                          srcset="../../static/img/portfolio/sport-desktop.webp 1x, ../../static/img/portfolio/sport-desktop@2x.webp 2x">
                  <source type="image/webp" media="(min-width: 992px)"
                          srcset="../../static/img/portfolio/sport-tablet.webp 1x, ../../static/img/portfolio/sport-tablet@2x.webp 2x">
                  <source type="image/webp" media="(min-width: 320px)"
                          srcset="../../static/img/portfolio/sport-mobile.webp 1x, ../../static/img/portfolio/sport-mobile@2x.webp 2x">
                  <source media="(min-width: 1200px)"
                          srcset="../../static/img/portfolio/sport-desktop.jpg 1x, ../../static/img/portfolio/sport-desktop@2x.jpg 2x">
                  <source media="(min-width: 992px)"
                          srcset="../../static/img/portfolio/sport-tablet.jpg 1x, ../../static/img/portfolio/sport-tablet@2x.jpg 2x">
                  <source media="(min-width: 320px)"
                          srcset="../../static/img/portfolio/sport-mobile.jpg 1x, ../../static/img/portfolio/sport-mobile@2x.jpg 2x">
                  <img src="../../static/img/portfolio/sport-mobile.jpg" alt="Sport Store" class="portfolio__pic lazyload"></picture>
                <figcaption class="portfolio__caption portfolio__caption--white portfolio__caption--black">Project "Sport
                  Store"
                </figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="http://ishop.mcdir.ru/" class="portfolio__link btn" target="_blank"
                                                 rel="noopener noreferrer">Live Demo</a> <a
                href="https://github.com/webistomin/my-shop" class="portfolio__link btn" target="_blank"
                rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--top" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  ...
                  <img src="../../static/img/portfolio/cat-mobile.jpg" alt="Cat Energy" class="portfolio__pic lazyload" width="" height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Cat Energy"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/cat-energy/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/cat-energy" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--margin" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  <source type="image/webp" media="(min-width: 1200px)"
                          srcset="../../static/img/portfolio/brume-desktop.webp 1x, ../../static/img/portfolio/brume-desktop@2x.webp 2x">
                  <source type="image/webp" media="(min-width: 992px)"
                          srcset="../../static/img/portfolio/brume-tablet.webp 1x, ../../static/img/portfolio/brume-tablet@2x.webp 2x">
                  <source type="image/webp" media="(min-width: 320px)"
                          srcset="../../static/img/portfolio/brume-mobile.webp 1x, ../../static/img/portfolio/brume-mobile@2x.webp 2x">
                  <source media="(min-width: 1200px)"
                          srcset="../../static/img/portfolio/brume-desktop.jpg 1x, ../../static/img/portfolio/brume-desktop@2x.jpg 2x">
                  <source media="(min-width: 992px)"
                          srcset="../../static/img/portfolio/brume-tablet.jpg 1x, ../../static/img/portfolio/brume-tablet@2x.jpg 2x">
                  <source media="(min-width: 320px)"
                          srcset="../../static/img/portfolio/brume-mobile.jpg 1x, ../../static/img/portfolio/brume-mobile@2x.jpg 2x">
                  <img src="../../static/img/portfolio/brume-mobile.jpg" alt="Brume" class="portfolio__pic lazyload" width="" height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Brume"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/brume-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/brume-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  ...
                  <img src="../../static/img/portfolio/arbitration-mobile.jpg" alt="Arbitration" class="portfolio__pic lazyload" width=""
                       height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Arbitration"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/arbitration-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/arbitration-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--margin" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  ...
                  <img src="../../static/img/portfolio/yes-mobile.jpg" alt="Yes" class="portfolio__pic lazyload" width="" height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Yes"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/yes-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/yes-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item" tabindex="0">
              <figure class="portfolio__figure">
              ...
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/cakes-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/cakes-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--margin" tabindex="0">
              <figure class="portfolio__figure">
                ...
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Mishka"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/mishka-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/mishka-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item" tabindex="0">
              <figure class="portfolio__figure">
                ...
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Park"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/park-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/park-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--margin" tabindex="0">
              <figure class="portfolio__figure">
              ...
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/pink-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/pink-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  ...
                  <img src="../../static/img/portfolio/accounting-mobile.jpg" alt="Accounting" class="portfolio__pic lazyload" width=""
                       height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Accounting"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/accounting-adaptive/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/accounting-adaptive" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
            <li class="portfolio__item portfolio__item--margin" tabindex="0">
              <figure class="portfolio__figure">
                <picture>
                  ...
                  <img src="../../static/img/portfolio/gllacy-mobile.jpg" alt="Gllacy" class="portfolio__pic lazyload" width="" height="">
                </picture>
                <figcaption class="portfolio__caption portfolio__caption--white">Project "Gllacy"</figcaption>
              </figure>
              <div class="portfolio__buttons"><a href="https://webistomin.github.io/gllacy-shop/"
                                                 class="portfolio__link btn" target="_blank" rel="noopener noreferrer">Live
                Demo</a> <a href="https://github.com/webistomin/gllacy-shop" class="portfolio__link btn" target="_blank"
                            rel="noopener noreferrer">View source</a></div>
            </li>
          </ul>
        </section>
